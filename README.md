...
This service is written in [Scala 2.13](http://www.scala-lang.org/) and [Play 2.8](http://playframework.com/), so needs at least a [JRE 11](http://www.oracle.com/technetwork/java/javase/downloads/index.html) to run.
